...
const Schedule = () => {
  ...
  const { schedule, isLoading, updateDayTitle, addExercise, updateExercise, deleteExercise, resetToDefault } = usePlaybook();
  ...
  return (
    <BoneyardSkeleton name="schedule-screen" loading={isLoading}>
          ...
          <div className="flex items-center justify-between px-1">
            ...
            <div className="flex gap-2">
              {editMode && (
                <button 
                  onClick={handleReset} 
                  className="h-9 w-9 text-destructive hover:bg-destructive/10 rounded-xl flex items-center justify-center transition-colors"
                >
